...
angular_ui_router: { src: bowerPath + "/angular-ui-router/release/anngular-ui-router.js"},
...
prd: "https://photo-stages.herokuapp.com"},
...
gulp.task("vendor_css", function(){
    return gulp.src([]).pipe(gulp.dest(cfg.vendor_css.bld));
